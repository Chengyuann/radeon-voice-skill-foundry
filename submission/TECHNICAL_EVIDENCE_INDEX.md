...
6. Submission evidence map: `SUBMISSION_EVIDENCE_MAP.md`
7. Live product: `https://radeon-voice-skill-foundry.pages.dev/`
8. Product Demo:
   `https://github.com/Chengyuann/radeon-voice-skill-foundry/releases/download/submission/RADEON_VOICE_SKILL_FOUNDRY_DEMO.mp4`
9. Project Specification: `PROJECT_SPECIFICATION.pdf`
10. Architecture: `ARCHITECTURE.png`
11. Poster: `POSTER.pdf`
12. Multi-turn refinement: `MULTI_TURN_REFINEMENT.png` and
   `MULTI_TURN_REFINEMENT.json`, with
   `MULTI_TURN_REFINEMENT_PROOF.zip`
13. Radeon evidence: `evidence/RADEON_SERVING_AND_ASR_SUMMARY.json`
