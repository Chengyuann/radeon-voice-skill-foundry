...
export type DemonstrationCommandType = DemonstrationCommand["type"];

export const demonstrationCommandTypes = [
  "open",
  "filter",
  ...
  "undo",
  "reset"
] as const satisfies readonly DemonstrationCommandType[];
