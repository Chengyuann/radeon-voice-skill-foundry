#!/usr/bin/env python3
"""Generate step narration for the live Cloudflare Demo V2."""
...
SOURCE = ROOT / "submission" / "DEMO_V2_NARRATION.md"
OUTPUT = ROOT / "tmp" / "demo-v2" / "narration"
...
DIRECTION = (
    ...
    "and short intentional pauses. Keep enough energy to match visible product "
    "actions, but avoid advertising cadence and exaggerated emphasis. Read the "
    "supplied text exactly once and stop after the final sentence. Do not "
    "repeat, improvise, or add an outro. Pronounce Radeon as ray-dee-on, ROCm "
    "as rock-em, Qwen as kwen, ASR as A-S-R, W7900 as W seventy-nine hundred, "
    "vLLM as vee-L-L-M, and P0 and P1 as P-zero and P-one."
)
