#!/usr/bin/env python3
"""Mix narration and captions into the live Cloudflare Demo V2 recording."""
...
RAW = ROOT / "tmp" / "demo-v2" / "recording" / "demo-v2-raw.webm"
EVENTS = ROOT / "tmp" / "demo-v2" / "recording" / "events.json"
AUDIO_DIR = ROOT / "tmp" / "demo-v2" / "narration"
WORK = ROOT / "tmp" / "demo-v2" / "build"
OUTPUT = ROOT / "submission" / "RADEON_VOICE_SKILL_FOUNDRY_DEMO_V2.mp4"
SRT = ROOT / "submission" / "RADEON_VOICE_SKILL_FOUNDRY_DEMO_V2.srt"
