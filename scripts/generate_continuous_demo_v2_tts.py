#!/usr/bin/env python3
"""Generate Charon narration for the isolated W7900 lifecycle Demo V2."""
...
OUTPUT = ROOT / "tmp" / "continuous-demo-v2" / "narration"
...
DIRECTION = (
    ...
    "register. Narrate a continuous product lifecycle demonstration in a calm, "
    "credible, quietly confident manner. Use conversational rhythm, crisp "
    "articulation, and short intentional pauses. Keep enough energy to match "
    "visible browser and service-restart actions, but avoid advertising "
    "cadence. Read the supplied text exactly once and stop after the final "
    "sentence. Do not repeat, improvise, or add an outro. Pronounce Radeon as "
    "ray-dee-on, ROCm as rock-em, Qwen as kwen, ASR as A-S-R, W7900 as W "
    "seventy-nine hundred, and P0 and P1 as P-zero and P-one."
)
    ...
    for index, title in enumerate(TITLES, start=1):
        ...
        if only_index in {0, index}:
            for generation_attempt in range(1, 4):
                ...
                duration_limit = max(50.0, len(text.split()) * 0.95)
